...
for iroi = 1:nrois
  ...
  save(froi, 'roi_name', 'subjects', 'conditions', 'nsubjs', 'contacts_labels', 'intersubj_corr', 'zscores_avg', ...
             'zscores_avg_avg', 'zscores_contacts_avg', 'interchan_corr', 'tvals_contacts', 'pvals_contacts', 'threshdur_contacts');
end
%% ---------------------------
